        ...
        <motion.div
            ...
            <div className="profile__wrap wrap">
                ...
                <div className="wrap__credentials credentials">
                    ...
                    <div className="credentials__sphere">Evgeny Arsaev</div>
            ...
            <div className="profile__information information">
                <div className="information__block">
                    ...
                    <div className="block__description description">
                        <ul className="description__list">
                            ...
                            <li>City: Temirtau</li>
                            <li>Age: 27</li>
                            <li>Job: <a className="description__link" href="https://via-tech.ru/" target="_blank"
                                        rel="noreferrer">Viasat Tech</a></li>
                            <li>Russian: native</li>
                            <li>English: advanced</li>
                            <li>Kazakh: near zero</li>
                        </ul>
                ...
                <div className="information__block">
                    ...
                    <div className="block__description">
                        I was born in 1996 in the city of Komsomolsk-on-Amur in the easternmost part of Russia. Since
                        childhood, I
                        was very fond of literature and everything complex, scientific and not so. My friend from here,
                        by the way,
                        introduced me to the world of Frontend Development, (Volodya, if you are reading this, respect
                        to you). I
                        love to develop fast, light, beautiful and convenient applications for everyday use. I am fond
                        of bicycles,
                        animals, playing the guitar and regularly try to find new challenges and master everything in
                        the world. Not
                        having much experience, I want to achieve everything myself and help people in a variety of
                        things. And I
